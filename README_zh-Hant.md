...
它不只是收集表單資料，也能處理申請送出後的完整流程，包括審查、核准、不核准、修正後重新送出，以及申請人查詢結果。
...
- 官方網站：https://labs.tungchi.jp/shinseiflow/
- 使用文件：https://labs.tungchi.jp/shinseiflow/docs/
- 支援頁面：https://labs.tungchi.jp/shinseiflow/support/
- 問題回報：https://labs.tungchi.jp/shinseiflow/issues/

目前網站仍在準備中，部分頁面可能暫時顯示臨時內容。
...
ShinseiFlow 以長期維護、操作體驗、隱私與 WordPress 相容性為主要設計原則。
