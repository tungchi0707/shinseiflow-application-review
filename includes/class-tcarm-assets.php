...
trait TCARM_Assets_Trait {
    ...
    public function frontend_assets() {
        ...
        // v0.1.65.5: fixed frontend inline CSS disabled for testing.
        // Fixed styles are now expected to be loaded from assets/css/frontend.css.
        // wp_add_inline_style('tcarm-frontend', $this->frontend_inline_css());
        $settings = self::get_settings();
